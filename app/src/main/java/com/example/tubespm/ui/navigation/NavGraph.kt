    ...
    fun AdminNavGraph(
        ...
        NavHost(
            ...
            // PERBAIKAN: Terapkan paddingValues di sini sekali untuk seluruh NavHost.
            // Hapus: modifier = Modifier.fillMaxSize()
            modifier = Modifier
                .fillMaxSize()
                .padding(paddingValues) // <-- INI YANG HILANG!
        ) {
            composable("admin_home") {
                // Karena padding sudah diterapkan di NavHost, HAPUS padding di sini
